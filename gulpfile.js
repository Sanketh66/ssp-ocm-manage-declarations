 ...
 */
 ...
 const SAP = "https://devs4hana2020.mercury.ssp-intl.com"
 // const SERVER_PROXY = "http://vsfdap01.mercury.ssp-intl.cloud:8101/"; // PRE
 const SERVER_PROXY = SAP;
const SOURCE_PATH = "./ocm-manage-declarations";
const SCRIPT_PATHS = "./src/**";
const DEST_PATH = "./dist_ocm-manage-declarations";
...
gulp.task("webserver", function(done) {
  ...
  if (SERVER_PROXY) {
    try {
        proxyCreds = require("../../.backend-credentials"); // Create this file if you want proxy access.
    } catch (error) {
        console.log(
          "File ./.backend-credentials not found. Using default proxy credentials."
        );
    }
...
var PRELOAD_NAMESPACE = "com.ssp.ocm.manage.declarations";
...
gulp.task("ui5preload", function() {
  ...
  return gulp
    .src([
      ...
      PRELOAD_BASE_FOLDER + "/resources/i18n/**",
